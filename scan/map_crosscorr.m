...
function [spatCorr] = map_crosscorr(interpBlRm, interpCompRm, varargin)

% 2D cross-correlation of rate maps.
%
%       C = map_crosscorr(map1, map2);
%       C = map_crosscorr(map1, map2, 'smooth');
%       C = map_crosscorr(map1, map2, 'smooth', filtSize, sigma);
%
