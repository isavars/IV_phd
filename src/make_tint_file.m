function make_tint_file(tetrode_mat,tetFileName,tetrode_number,trialInfo) %,DACQinfo -removed
...
scaleMax = 100; % can hardcode because its always the same for me  ut check if this value makes sene - DACQinfo.scaleMax(tetrode_number,:);
