...
trialInfo.writeDir = fileName.folder;
    ...
    [tet1FileName] = specificTetHeader(genericTetHeader,trialInfo,spike_count,1);
...
%     [tet8FileName] = specificTetHeader(genericTetHeader,trialInfo,num_spikes,8);
    ...
    make_tint_file(spike_mat,tet1FileName,1,trialInfo); % removed ,DACQinfo
...
%     make_tint_file(tetrode5,tet5FileName,5,trialInfo,DACQinfo);
%     make_tint_file(tetrode6,tet6FileName,6,trialInfo,DACQinfo);
%     make_tint_file(tetrode7,tet7FileName,7,trialInfo,DACQinfo);
%     make_tint_file(tetrode8,tet8FileName,8,trialInfo,DACQinfo);